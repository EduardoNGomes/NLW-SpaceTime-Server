...
var envSchema = import_zod3.z.object({
  DATABASE_URL: import_zod3.z.string(),
  PORT: import_zod3.z.coerce.number(),
  GITHUB_CLIENT_ID: import_zod3.z.string(),
  GITHUB_CLIENT_SECRET: import_zod3.z.string(),
  CLOUD_NAME: import_zod3.z.string(),
  API_KEY: import_zod3.z.string(),
  API_SECRET: import_zod3.z.string()
});
